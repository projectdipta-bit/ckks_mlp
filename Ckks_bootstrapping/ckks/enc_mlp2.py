...
if __name__ == "__main__":
    ...
    # N=64 gives exactly 32 slots (N//2), matching in_dim=32. Minimising N
    # keeps poly_mul fast (O(N²)).
    params = ParameterSet(
    ...
    # Need rotation keys for powers of 2: 1, 2, 4, 8, 16  (to sum 32 slots)
    rot_keys = gen_rotation_keys(s, params.N, params.q, params.P, max_j=16)

    mlp = EncMLP(32, 16, 10, params, EK, rot_keys, PK, s)
